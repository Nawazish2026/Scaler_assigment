...
exports.bookMeeting = exports.getAvailableSlots = exports.getEventBySlug = void 0;
...
const getAvailableSlots = async (req, res, next) => {
    try {
        ...
        const hostEventTypes = await prisma_1.default.eventType.findMany({
            where: { userId: eventType.userId },
            select: { id: true }
        });
        ...
        const conflictingMeetings = await prisma_1.default.meeting.findMany({
            where: {
